import { Collection, Snowflake, Message, ChatInputCommandInteraction } from 'discord.js'
async function results(deletedMessages:Collection<Snowflake, Message>, interaction:ChatInputCommandInteraction) {
    const results:any = {};
